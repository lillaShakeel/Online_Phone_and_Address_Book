...
if(isset($_POST['submit'])){
	$search=$_POST['search'];
	$sql1="select * from user where firstname LIKE '%$search%' OR lastname LIKE '%$search%' OR contact LIKE '%$search%' OR city LIKE '%$search%' OR address LIKE '%$search%'";
...
<h4><i class="fa fa-search"></i> Search Result: <?php echo mysqli_num_rows($result1);?></h4>
</div>
</div>
<div class="row">
...
<?php
	...
	?>
    <h4 class="text-center">No User Available</h4>
<?php
}
?>
</div>
